...
public class NongLi {
	...
	public void abc(String s, int i){

	}

	public void abc(String s, int i, long l){
	...
	public static void main(String[] args) throws Exception{
		Method[] methods=NongLi.class.getDeclaredMethods();
		for(int i=0; i<methods.length; i++){
			System.out.println(methods[i].getName()+","+ Modifier.isStatic(methods[i].getModifiers())+" -> ");
