...
public class JUtilMD5 {
	...
	private static String stringify(byte bytes[]) {
		...
		for (int i = 0; i < bytes.length; i++) {
			...
			int k = bytes[i] & 0xf;
			stringbuffer.append(((char) (j <= 9 ? 48 + j: (97 + j) - 10)));
			stringbuffer.append(((char) (k <= 9 ? 48 + k: (97 + k) - 10)));
		}
	...
	public static void main(String args[]) throws Exception {
		System.out.println(JUtilMD5.MD5EncodeToHex("f379eaf3c831b04de153469d1bec345e"));
	}
}