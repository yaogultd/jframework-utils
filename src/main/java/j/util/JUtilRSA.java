...
public class JUtilRSA{
	...
	public static boolean verify(String expectedSignature,
			...
			String ALGO){
		try{
			Collection<X509Certificate> clientCerts=getX509CertificateFromStream(publicKeyIs);
	 ...
	 * @throws Exception
	 */
	public static String publicEncrypt(String data, String publicKey, String algorithm, String CHARSET) throws Exception{
		RSAPublicKey pubKey = JUtilRSA.getPublicKey(publicKey);
		...
		return JUtilBase64.encode(encryptedBytes, true);
	}
     ...
     * @throws Exception
     */
	public static String privateDecrypt(String data, String privateKey, int blockSize, String CHARSET) throws Exception{
     ...
     * @throws Exception
     */
	public static String publicDecrypt(String data, String publicKey, int blockSize, String CHARSET) throws Exception{
		RSAPublicKey pubKey = JUtilRSA.getPublicKey(publicKey);
...
//
//		//生成密匙对
//		String[] pair=createKeyPair(512);
//		System.out.println("公钥 -> "+pair[0]);
//		System.out.println("私钥 -> "+pair[1]);
//
//		//待加密数据
//		String s="sss";
//
//		//用私钥加密
//		s=privateEncrypt(s, pair[1], 512, "UTF-8");
//		System.out.println("加密后数据 -> "+s);
//
//		//用公钥解密
//		s=publicDecrypt(s, pair[0], 512, "UTF-8");
...
//		System.exit(0);
		...
		String pk = "MIGeMA0GCSqGSIb3DQEBAQUAA4GMADCBiAKBgH1ufjmfY7tAt14i4z1ba8HvjCEfHeGdG8+9ABVbZhPphrW15dyb/Q6HfTCyBwDLdGZViiPcXli3/guMfv83o6nLZPyzgg8f7fblKF9vB5l9AmuzKSVL/8DCBaIXIr1aRmMBV04f1v4xXPyUdNXQkzDkXobXwPpk3jyb/K/XKefJAgMBAAE=";
		System.out.println(publicEncrypt("As123123", pk, RSA_ECB_PKCS1Padding, "UTF-8"));
